            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/50">{t("marketing.recipients")}</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                {[...Array(3)].map((_, i) => (
                  <motion.div 
                    ...
                    className="p-4 rounded-xl bg-foreground/5 flex items-center justify-between shadow-inner hover:bg-foreground/10 transition-colors cursor-default"
                  >
              ...
              <button className="w-full mt-6 bg-brand hover:bg-brand-hover text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-transform transform hover:scale-102 active:scale-95 shadow-xl shadow-brand/20">
